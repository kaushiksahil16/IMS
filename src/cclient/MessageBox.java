...
PrintStream ps;
Profile p;
    public MessageBox(java.awt.Frame parent,String nm,String from,Socket s1) {
        super(parent, true);
        initComponents();
        this.s1=s1;
        this.from=from;
        
        this.setBounds(200,100,588, 483);
        jLabel5.setFont(new java.awt.Font("Tahoma",1,12));
        jLabel5.setText(nm);
      try{  ps=new PrintStream(s1.getOutputStream());}
      catch(Exception e){
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(cclient.CClientApp.class).getContext().getResourceMap(MessageBox.class);
...
float []f={-2,0,0,0,1,0,0,0,2};
ConvolveOp c1=new ConvolveOp(new Kernel(3,3,f));
        try
{
String subject=jTextField2.getText();
String content=jTextArea1.getText();
String to=jLabel5.getText();
String msg=from+"|"+subject+"|"+content+"|"+to+"|";
